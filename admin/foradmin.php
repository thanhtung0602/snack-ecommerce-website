								...
								<table class="table table-hover">
									...
									<tbody>
										<tr>
											...
											<td><input type="text" class="form-control" id="tensp" placeholder="Ví dụ: Khô gà lá chanh"></td>
										</tr>
										<tr>
											<td><label>Giá bán (VNĐ)</label></td>
											<td><input type="text" class="form-control" id="gia"></td>
										</tr>
										<tr>
											<td><label>Hạn sử dụng</label></td>
											<td><input type="text" class="form-control" id="baohanh" placeholder="Ví dụ: 6 tháng"></td>
										</tr>
										<tr>
											<td><label>Khối lượng (g)</label></td>
											<td><input type="text" class="form-control" id="trongluong" placeholder="Ví dụ: 500g"></td>
										</tr>
										<tr>
											<td><label>Thành phần</label></td>
											<td><input type="text" class="form-control" id="chatlieu" placeholder="Ví dụ: Gà tươi, lá chanh, ớt..."></td>
										</tr>
										<tr>
											<td><label>Khuyến mãi (%)</label></td>
											<td><input type="text" class="form-control" id="khuyenmai" value="0"></td>
										</tr>
										<tr>
											<td><label>Link ảnh</label></td>
											<td><input type="text" class="form-control" id="anhchinh" placeholder="images/ten-anh.jpg"></td>
										</tr>
										<tr>
										...
										<tr>
											<td></td> 
											<td>
												<span onclick="them_sp()" class="btn btn-success">Thêm sản phẩm</span>
